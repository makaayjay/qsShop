    ...
    export default {
        ...
        methods:{
            _getBScroll(){
                ...
                const picsLi=picsUl.getElementsByTagName('li')
                let li=Array.from(picsLi)//伪数组转为真数组
                console.log(picsLi,li[0].offsetWidth)//得到Li的宽度
                picsUl.style.width=(li[0].offsetWidth+6)*li.length+'px'//设定UL的宽度
